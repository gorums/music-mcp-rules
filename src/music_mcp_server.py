...
@mcp.tool()
def get_band_list_tool() -> Dict[str, Any]:
    """
    Get a list of all discovered bands with album information.
    
    Returns:
        Dict containing the list of bands with album counts and metadata status
    """
    try:
